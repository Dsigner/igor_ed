...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { avatar: @instructor.avatar, badges: @instructor.badges, bio: @instructor.bio, name: @instructor.name, profession: @instructor.profession, projects: @instructor.projects, xp: @instructor.xp }
    end
  ...
  test "should update instructor" do
    put :update, id: @instructor, instructor: { avatar: @instructor.avatar, badges: @instructor.badges, bio: @instructor.bio, name: @instructor.name, profession: @instructor.profession, projects: @instructor.projects, xp: @instructor.xp }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
